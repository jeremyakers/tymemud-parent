...
for z in zones:
    ...
    for i in range(0, len(rooms), 2):
        ...
        if sector == 11:
            ...
            desc = strip_ansi(raw_desc).lower()
            
            # Check for bad patterns in road descriptions
            # 1. Distance patterns (looking AT the road)
            distance_patterns = ['roads can be seen', 'road can be seen', 'see the road', 'see a road', 'road lies', 'distant road', 'smudge of road', 'horizon']
